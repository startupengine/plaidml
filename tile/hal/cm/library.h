...
class cmLibrary final : public hal::Library {
 public:
  static cmLibrary* Downcast(hal::Library* library, std::shared_ptr<cmDeviceState> device_state);

  cmLibrary(std::shared_ptr<cmDeviceState> device_state, const std::map<std::string, CmProgram*>& program_map,
